...
> - **Google Play** : **rien à faire**, vérifié en console le 05/08. Examen IARC **« Terminée »**, certificat `2c29d9f0-f220-8848-8060-3f6e3862d08c`, questionnaire envoyé le 08/07 à 13h47. Classifications réelles : **TEEN** (Amérique du Nord), **USK 12** (Allemagne), **IARC 12+**, plusieurs **12** régionaux, et pour l'Europe **PEGI « Accord parental recommandé »** (icône « ! » orange) — et non « PEGI 12 » comme écrit précédemment. C'est ce libellé qui s'affiche sur la fiche publique française. Ce n'est **pas** un défaut : l'IARC l'attribue aux applications (≠ jeux) comportant du contenu généré par les utilisateurs et de la messagerie, ce qui est exactement le cas de Plyz et ce qui a été déclaré à Apple. ⚠️ **Ne pas relancer « Répondre au nouveau questionnaire »** : cela ne changerait pas le label et relancerait un cycle de vérification pour rien.
>
