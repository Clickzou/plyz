  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 10 }]}>
        ...
        <Text style={styles.headerTitle}>{t('termsScreenTitle')}</Text>
      </View>

      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <Text style={styles.title}>{t('termsOfUseTitle')}</Text>
        ...
        <Text style={styles.sectionTitle}>{t('termsSection6Title')}</Text>
        <Text style={styles.text}>
          {t('termsSection6Text')}
        </Text>

        <Text style={styles.sectionTitle}>{t('termsSection7Title')}</Text>
        <Text style={styles.text}>
          {t('termsSection7Text')}
        </Text>
      </ScrollView>
